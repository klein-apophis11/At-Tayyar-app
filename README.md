...
https://github.com/user-attachments/assets/53a276d1-f72e-47da-889e-a7a2d8dd9834
...
The app is built for Windows/Linux and is intended to run locally without any internet dependency, login requirement, or microphone/camera access. It is designed to keep the experience simple, secure, and easy to use during routine prayer practice.
